...
} from "./chunk-GCR4ASPU.js";
import "./chunk-E2WS5KGY.js";
import {
  require_cjs
...
var InternalQueryReference = class {
  ...
  subscribeToQuery() {
    this.subscription = this.observable.pipe((0, import_rxjs.filter)((result) => !equal(result, this.result))).subscribe(this.handleNext);
    this.subscription.add(this.onDispose);
  }
  setResult() {
...
function useResult(observable, resultData, ssr) {
  ...
  return useSyncExternalStore(React13.useCallback((handleStoreChange) => {
    const subscription = observable.pipe((0, import_rxjs2.observeOn)(import_rxjs2.asapScheduler)).subscribe((result) => {
