...
function useInterval(callback, delay, enabled = true) {
  const _callback = (0, import_react3.useRef)();
...
function NavButtons() {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)("div", { className: prevNavClassName, onClick: goBack, children: (0, import_jsx_runtime.jsx)(
      "svg",
      {
    ...
    (0, import_jsx_runtime.jsx)("div", { className: nextNavClassName, onClick: goForward, children: (0, import_jsx_runtime.jsx)(
      "svg",
      {
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 20 20",
...
var PageIndicators = () => {
  ...
  return (0, import_jsx_runtime2.jsx)("div", { className: "nuka-page-container", "data-testid": "pageIndicatorContainer", children: [...Array(totalPages)].map((_, index) => (0, import_jsx_runtime2.jsx)(
    "button",
    {
      onClick: () => goToPage(index),
      className: className(index),
      children: (0, import_jsx_runtime2.jsx)("span", { className: "nuka-hidden", children: index + 1 })
    },
    index
  )) });
};
...
var defaults = {
  arrows: (0, import_jsx_runtime3.jsx)(NavButtons, {}),
  autoplay: false,
  autoplayInterval: 3e3,
  dots: (0, import_jsx_runtime3.jsx)(PageIndicators, {}),
  id: "nuka-carousel",
  keyboard: true,
  minSwipeDistance: 50,
...
var Carousel = (0, import_react2.forwardRef)(
  (props, ref) => {
    ...
    const previousPageRef = (0, import_react2.useRef)(-1);
    const arrowsContainerRef = (0, import_react2.useRef)(null);
    ...
    const [touchStart, setTouchStart] = (0, import_react2.useState)(null);
    const [touchEnd, setTouchEnd] = (0, import_react2.useState)(null);
    ...
    (0, import_react2.useImperativeHandle)(ref, () => ({ goForward, goBack, goToPage }), [
      goForward,
      goBack,
      goToPage
    ]);
    ...
    return (0, import_jsx_runtime3.jsxs)(CarouselProvider, { value: providerValues, children: [
      (0, import_jsx_runtime3.jsxs)(
        "div",
        {
          ...
          id,
          children: [
            title && (0, import_jsx_runtime3.jsx)("h3", { id: "nuka-carousel-heading", className: "nuka-hidden", children: title }),
            (0, import_jsx_runtime3.jsxs)("div", { className: "nuka-slide-container", children: [
              ...
              showArrows && (0, import_jsx_runtime3.jsx)("div", { ref: arrowsContainerRef, children: arrows })
            ] })
          ]
        }
      ),
