...
import {
  ...
  useNavigate,
  useNavigation
} from "./chunk-5BIJRVL6.js";
import "./chunk-QT4YTOOP.js";
import {
  require_react
...
function AnalyticsPageView(props) {
  return (0, import_jsx_runtime.jsx)(AnalyticsView, { ...props, type: "page_viewed" });
}
function AnalyticsProductView(props) {
  return (0, import_jsx_runtime.jsx)(AnalyticsView, { ...props, type: "product_viewed" });
}
function AnalyticsCollectionView(props) {
  return (0, import_jsx_runtime.jsx)(AnalyticsView, { ...props, type: "collection_viewed" });
}
function AnalyticsCartView(props) {
  return (0, import_jsx_runtime.jsx)(AnalyticsView, { ...props, type: "cart_viewed" });
}
function AnalyticsSearchView(props) {
  return (0, import_jsx_runtime.jsx)(AnalyticsView, { ...props, type: "search_viewed" });
}
function AnalyticsCustomView(props) {
  return (0, import_jsx_runtime.jsx)(AnalyticsView, { ...props });
}
var AnalyticsEvent = {
  // Views
...
function useApisLoaded({
  ...
  const observing = (0, import_react.useRef)({ customerPrivacy: false, privacyBanner: false });
  const [apisLoaded, setApisLoaded] = (0, import_react.useState)(
...
function AnalyticsProvider({
  ...
  var _a3;
  const listenerSet = (0, import_react.useRef)(false);
  const { shop } = useShopAnalytics(shopProp);
  const [analyticsLoaded, setAnalyticsLoaded] = (0, import_react.useState)(
    customCanTrack ? true : false
  );
  const [carts, setCarts] = (0, import_react.useState)({ cart: null, prevCart: null });
  const [canTrack, setCanTrack] = (0, import_react.useState)(
  ...
  return (0, import_jsx_runtime.jsxs)(AnalyticsContext.Provider, { value, children: [
    children,
    !!shop && (0, import_jsx_runtime.jsx)(AnalyticsPageView, {}),
    !!shop && !!currentCart && (0, import_jsx_runtime.jsx)(CartAnalytics, { cart: currentCart, setCarts }),
    !!shop && consent.checkoutDomain && (0, import_jsx_runtime.jsx)(
      ShopifyAnalytics,
      {
        consent,
        onReady: () => {
    ...
    !!shop && (0, import_jsx_runtime.jsx)(PerfKit, { shop })
  ] });
}
...
function CartForm({
  ...
  return (0, import_jsx_runtime.jsxs)(fetcher.Form, { action: route || "", method: "post", children: [
    (action || inputs) && (0, import_jsx_runtime.jsx)(
      "input",
      {
        type: "hidden",
        name: INPUT_NAME,
...
var Script = (0, import_react.forwardRef)(
  (props, ref) => {
    const { waitForHydration, src, ...rest } = props;
    const nonce = useNonce();
    if (waitForHydration) return (0, import_jsx_runtime.jsx)(LazyScript, { src, options: rest });
...
async function hydrogenRoutes(currentRoutes) {
  const { getVirtualRoutesV3 } = await import("./get-virtual-routes-6PVSMJPH-J32EJXI5.js");
...
function OptimisticInput({ id, data }) {
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)("input", { type: "hidden", name: "optimistic-identifier", value: id }),
...
function Pagination({
  ...
  const state = (0, import_react.useMemo)(
    () => {
      ...
      return {
        ...location.state,
        pagination: {
          ...((_a3 = location.state) == null ? void 0 : _a3.pagination) || {},
          [namespace]: {
            pageInfo: {
              endCursor,
              hasPreviousPage,
  ...
  const NextLink = (0, import_react.useMemo)(
  ...
  const PreviousLink = (0, import_react.useMemo)(
    () => (0, import_react.forwardRef)(
...
var RichText2 = function(props) {
  return (0, import_jsx_runtime.jsx)(
    RichText,
    {
      ...props,
      components: {
        link: ({ node }) => (0, import_jsx_runtime.jsx)(
          Link,
          {
            to: node.url,
            title: node.title,
...
async function storefrontRedirect(options) {
  ...
  try {
    ...
    const location = (_c = (_b = (_a3 = urlRedirects == null ? void 0 : urlRedirects.edges) == null ? void 0 : _a3[0]) == null ? void 0 : _b.node) == null ? void 0 : _c.target;
    if (location) {
      return createRedirectResponse(
        location,
        isSoftNavigation,
...
var SeoLogger = (0, import_react.lazy)(() => import("./log-seo-tags-IG37ONQ2-JFRKXO6M.js"));
function Seo({ debug }) {
  ...
  const { html, loggerMarkup } = (0, import_react.useMemo)(() => {
    ...
    const html2 = headTags.map((tag) => {
      ...
      return (0, import_react.createElement)(tag.tag, { ...tag.props, key: tag.key }, tag.children);
    });
    const loggerMarkup2 = (0, import_react.createElement)(
      import_react.Suspense,
      { fallback: null },
      (0, import_react.createElement)(SeoLogger, { headTags })
    );
...
function ShopPayButton2(props) {
  return (0, import_jsx_runtime.jsx)(ShopPayButton, { channel: "hydrogen", ...props });
}
